...
export default class MainPage extends React.Component {
    render(){
        return(
            ...
            <div className='intro'><span>Welcome to Double Jump!</span><br></br><p>This sites purpose is to provide reviews and a means to purchase video games and accessories</p><p>Sign up to utilize the most of this site.</p></div>
